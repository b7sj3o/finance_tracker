...
urlpatterns = [
    ...
    path('income/<int:pk>/', RetrieveUpdateDestroyIncomeView.as_view(), name='income-detail'),
    path('expense/', ListCreateExpenseView.as_view(), name='expense-list-create'),
    path('expense/<int:pk>/', RetrieveUpdateDestroyExpenseView.as_view(), name='expense-detail'),
    path('category/', ListCreateCategoryView.as_view(), name='category-list-create'),
    path('category/<int:pk>/', RetrieveUpdateDestroyCategoryView.as_view(), name='category-detail'),
]
